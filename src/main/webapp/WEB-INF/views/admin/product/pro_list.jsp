              ...
              <div class="box-header with-border">
                <div class="form-group row">
                  ...
                  <div class="col-md-2">
                    ...
                    <button type="button" id="btn_checkedDelete" class="btn btn-primary">선택상품 삭제</button>
                  </div>
                </div>
              </div>
                  ...
                  <tbody>
                    ...
                    <c:forEach items="${pro_list}" var="productVO">
                      <tr>
                        ...
                        <td><button type="button" name="btn_productEdit" data-prd_no="${productVO.prd_no }" class="btn btn-link">수정</button></td>
                        <td><button type="button" name="btn_productDelete" data-prd_no="${productVO.prd_no }" class="btn btn-link">삭제</button></td>
                      </tr> 
                    </c:forEach>
                  </tbody>
                </table>
